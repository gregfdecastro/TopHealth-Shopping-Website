     ...
     <li><a href="about.php">About</a></li>
       ...
       <div class="dropdown">
           <a href="#"><button type="button">Admin</button> </a> 
                 ...
                 <a style="font-size: medium;" href="admin-sales.php">Check orders</a>
                 <a style="font-size: medium;" href="admin-feedback.php">Check feedbacks</a>
...
<form style="border-style: solid;
    border-color: #2691d9; border-width: 2px; border-radius: 10px;" action="" method="post" class="add-product-form" enctype="multipart/form-data">
   ...
   <table>
      ...
      <tbody>
         ...
         <tr>
            ...
            <td>
               <a style="background-color: #D11A2A ;" href="admin-cart.php?delete=<?php echo $row['id']; ?>" class="delete-btn" onclick="return confirm('are your sure you want to delete this?');"> <i class="fas fa-trash"></i> delete </a>
               <a style="background-color: #ffa500 ;" href="admin-cart.php?edit=<?php echo $row['id']; ?>" class="option-btn"> <i class="fas fa-edit"></i> update </a>
            </td>
         </tr> 
