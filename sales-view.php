...
{
    $user_id = mysqli_real_escape_string($con, $_POST['delete_order']);

    $query = "DELETE FROM purchase WHERE id='$user_id' ";
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Order details
                        <a href="admin-sales.php" class="btn btn-danger float-end">BACK</a>
                        </h4>
                    </div>
                    <div class="card-body">
                        ...
                        if(isset($_GET['id']))
                        {
                            ...
                            $query = "SELECT * FROM purchase WHERE id='$user_id' ";
                            $query_run = mysqli_query($con, $query);
